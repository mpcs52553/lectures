...
**IMPORTANT**: Take Self-Assessment #1 in Canvas before leaving the classroom today.
...
* Quizzes must be taken before LEAVING class on that date.
* This class contains some video lessons to be watched outside of class. Classroom sessions will generally average 2 hours instead of the usual 3, but actual class time will vary from week to week.
...
* A fourth browser language, WebAssembly, is under development and being adopted by the major browsers, but is not yet fully implemented.
